namespace vars{
    public static class Contents{
        ...
        public static string nivelLivro = "Exercicios acompanhados do livro C# para iniciantes";

        public static string[] cesta = {"5 laranjas","10 goiabas vermelhas","5  pêssegos doces","10 bananas d'água"};

        // datas:
        public static int dia = 12;
        public static int mes = 05;
